...
import { ChunkRepositoryService, CreateChunkDTO, Chunk } from 'src/database/filehandling/chunk/chunk.repository.service';
...
// Create feature extraction pipeline
  ...
  async findRelevantChunks(taskId: string, question: string, topK = 5): Promise<Chunk[]> {
    ...
    // const allChunks = await this.chunkRepo
